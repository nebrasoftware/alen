...
Revision ID: c561a09d04bc
Revises: 
Create Date: 2019-03-12 13:51:35.344609
...
def upgrade():
    ...
    op.create_table('driving_license',
    ...
    sa.ForeignKeyConstraint(['driving_license_id'], ['driving_license.id'], ),
